// SoloStrike API server (v1.11.44 — privacy-aware)
...
wss.on('connection', (ws, req) => {
  ...
  wsClients++;
  // v1.11.44 FIX: on-connection welcome message ships FULL transformState
...
setInterval(() => {
  if (wss.clients.size === 0) return;
    // v1.11.44: diagnostic — log broadcast size every 60 seconds so we can
