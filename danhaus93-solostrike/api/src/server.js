...
const state = {
  ...
  releaseNotes:
    "• Footer is now pinned — version, GitHub link, and ports stay visible while you scroll\n" +
    "• Removed the soft-update banner path — iOS PWA timing was unreliable\n" +
    "• Hard-update banner remains for breaking compose changes\n" +
    "• Service worker still handles offline shell caching",
};
