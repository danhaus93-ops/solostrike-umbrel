// SoloStrike API server (v1.11.41 — privacy-aware)
...
wss.on('connection', (ws, req) => {
  ...
  wsClients++;
  // v1.11.41 FIX: on-connection welcome message ships FULL transformState
...
setInterval(() => {
  if (wss.clients.size === 0) return;
    // v1.11.41: diagnostic — log broadcast size every 60 seconds so we can
