...
const state = {
  ...
  releaseNotes:
    "• Stratum card is now editable — tap any field to type your host, workername, or pass\n" +
    "• Footer ports now copy URLs using YOUR configured host (was leaking the dashboard URL)\n" +
    "• Default host is umbrel.local — works on most home networks\n" +
    "• PASS field shows examples for fixed-difficulty (d=10000) usage\n" +
    "• Three port chips with live status, tap any to copy that stratum URL",
};
