...
const state = {
  ...
  releaseNotes:
    "• NEW: HashPulse — Firepower and Pulse cards combined into one card\n" +
    "• Firepower section on top (live TH/s + chart), Pulse beneath (network census)\n" +
    "• Both sections shrunk to fit together — no scroll needed\n" +
    "• Existing card layouts auto-migrate (hashrate/pulse → hashpulse)\n" +
    "• v1.7.19 sizing fix + Settings → Display layout toggle (Carousel/Vertical)",
};
