...
const state = {
  ...
  releaseNotes:
    "• In-app update banner — SoloStrike tells you when new versions are ready\n" +
    "• ⚡ Soft updates: tap to reload, ~2 seconds\n" +
    "• 🔧 Hard updates: clear instructions to use Umbrel\n" +
    "• Expandable release notes pulled live from the API\n" +
    "• Dismissible (except critical updates) — remembers your choice",
};
