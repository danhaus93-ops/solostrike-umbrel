// SoloStrike API server (v1.11.45 — privacy-aware)
...
wss.on('connection', (ws, req) => {
  ...
  wsClients++;
  // v1.11.45 FIX: on-connection welcome message ships FULL transformState
...
setInterval(() => {
  if (wss.clients.size === 0) return;
    // v1.11.45: diagnostic — log broadcast size every 60 seconds so we can
