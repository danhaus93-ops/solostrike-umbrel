...
const state = {
  ...
  releaseNotes:
    "• Worker offline banners — persistent, dismissible alerts when a worker drops\n" +
    "• ▲▼ Hashrate trend arrow next to the live TH/s — green up / red down, 5-min window\n" +
    "• Tap any port in the footer to copy the full stratum URL to clipboard\n" +
    "• Multiple offline workers collapse into one banner with expandable list\n" +
    "• Recovered workers flash a green ✓ BACK ONLINE confirmation",
};
