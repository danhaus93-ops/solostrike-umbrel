...
# Wait for Bitcoin Core to be reachable
...
# If no config exists yet, write a placeholder (API will update with real address)
  ...
  cat > "$CONFIG_FILE" <<EOF
{
  ...
  "btcaddress": "bc1qplaceholderpleasesetaddressinui",
  "btcsig": "SoloStrike/",
  "blockpoll": 100,
  "nonce1length": 4,
  "nonce2length": 8,
