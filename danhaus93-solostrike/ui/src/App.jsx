...
// Strip BTC address prefix from workername. "bc1q...wgsk.S19XP" -> "S19XP"
...
// ── Best Share Leaderboard (naming fix) ───────────────────────────────────────
        ...
        <div style={{display:'flex',flexDirection:'column',gap:'0.35rem'}}>
          {sorted.map((w, i) => (
            <div key={w.name} style={{display:'flex',alignItems:'center',gap:'0.6rem',padding:'0.55rem 0.8rem',background:'var(--bg-raised)',border:`1px solid ${i===0?'rgba(245,166,35,0.3)':'var(--border)'}`}}>
              ...
              <div style={{flex:1,minWidth:0,fontFamily:'var(--fm)',fontSize:'0.75rem',color:'var(--text-1)',overflow:'hidden',textOverflow:'ellipsis',whiteSpace:'nowrap'}} title={w.name}>
                {shortName(w.name)}
              </div>
...
const DEFAULT_ORDER = [
  'hashrate', 'workers', 'network', 'odds', 'luck', 'retarget',
