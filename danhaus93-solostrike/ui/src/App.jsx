      ...
      <div style={{display:'flex', flexDirection:'column', gap:'0.875rem'}}>
        ...
        <div>
          ...
          <svg viewBox="0 0 600 60" preserveAspectRatio="none"
            ...
            {(() => {
              const branches = [
                // ── Main trunk (left to right, gently sloping up) ──
                { d: "M 2 38 Q 60 36, 110 32 T 230 26 Q 320 22, 420 24 T 598 18", w: 2.8 },

                // ── Big primary forks off the main trunk ──
                { d: "M 50 37 Q 70 22, 95 8",        w: 1.8 },  // up-left, steep
                { d: "M 110 32 Q 140 18, 175 6",     w: 1.6 },  // up
                { d: "M 175 28 Q 200 14, 230 4",     w: 1.5 },  // up sharper
                { d: "M 230 26 Q 280 14, 320 6",     w: 1.7 },  // long sweep up
                { d: "M 320 22 Q 350 10, 390 2",     w: 1.5 },  // up to top
                { d: "M 420 24 Q 460 14, 510 6",     w: 1.7 },  // late up
                { d: "M 510 21 Q 540 12, 575 4",     w: 1.4 },  // tail up

                // ── Down branches (sparser, like the ref image) ──
                { d: "M 90 33 Q 105 44, 120 56",     w: 1.3 },
                { d: "M 270 24 Q 290 38, 305 52",    w: 1.2 },
                { d: "M 440 24 Q 470 38, 490 54",    w: 1.3 },

                // ── Sub-branches off the up-forks (recursive feel) ──
                { d: "M 80 18 Q 88 12, 100 14",      w: 1.0 },  // off first fork
                { d: "M 145 14 Q 158 8, 168 12",     w: 0.9 },  // off second fork
                { d: "M 210 8  Q 222 4, 235 10",     w: 0.9 },  // off third
                { d: "M 280 10 Q 290 4, 302 8",      w: 1.0 },  // off fourth
                { d: "M 360 6  Q 370 2, 384 6",      w: 0.8 },  // off fifth
                { d: "M 470 10 Q 480 4, 494 8",      w: 0.9 },  // off late-up
                { d: "M 545 8  Q 555 4, 568 10",     w: 0.8 },  // off tail

                // ── Fine capillaries (very thin, scattered) ──
                { d: "M 35 38 L 42 30",              w: 0.7 },
                { d: "M 130 22 L 138 14",            w: 0.7 },
                { d: "M 195 12 L 200 4",             w: 0.6 },
                { d: "M 250 18 L 258 10",            w: 0.7 },
                { d: "M 340 14 L 348 6",             w: 0.6 },
                { d: "M 405 18 L 412 10",            w: 0.6 },
                { d: "M 480 18 L 486 12",            w: 0.7 },
                { d: "M 530 16 L 538 10",            w: 0.6 },

                // ── Tiny down stubs ──
                { d: "M 165 32 L 170 38",            w: 0.7 },
                { d: "M 380 24 L 386 30",            w: 0.6 },
                { d: "M 560 18 L 566 24",            w: 0.6 },
              ];
              return (
                <>
