  ...
  return (
    ...
    >
      ...
      <div style={{display:'flex', flexDirection:'column', gap:'0.875rem'}}>
        ...
        {/* Per-block odds — horizontal progress bar (v1.7.22 redesign).
            Replaces the 110px tall orbital gauge with a compact bar that
            shows the same scaled value horizontally, freeing up vertical
            space for the rest of the card. Same log scaling. */}
        <div>
          ...
          {/* The bar itself: track + animated amber fill scaled to same `scale` value */}
          <div style={{
            height:8, width:'100%',
            background:'var(--bg-raised)',
