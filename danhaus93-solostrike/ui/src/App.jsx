...
export default function App() {
  ...
  return (
    <>
     ...
     <div className="ss-app-header" style={{ background:'rgba(6,7,8,0.92)', backdropFilter:'blur(10px)', WebkitBackdropFilter:'blur(10px)', width:'100%', maxWidth:'100%', boxSizing:'border-box', overflow:'hidden', paddingTop:'env(safe-area-inset-top)' }}>
      ...
      <main className={`ss-app-main ${useCarousel ? 'ss-carousel-wrap' : ''}`} style={{padding: useCarousel ? 0 : '0.65rem'}}>
        <div
          ref={carouselRef}
        ...
        <footer className="ss-app-footer" style={{borderTop:'1px solid var(--border)',padding:'0.6rem 0.75rem',paddingBottom:'calc(0.6rem + env(safe-area-inset-bottom))',display:'flex',justifyContent:'space-between',alignItems:'center',fontFamily:'var(--fd)',fontSize:'0.5rem',color:'var(--text-3)',letterSpacing:'0.06em',textTransform:'uppercase',gap:'0.5rem',flexWrap:'nowrap',width:'100%',maxWidth:'100%',boxSizing:'border-box',whiteSpace:'nowrap',background:'rgba(6,7,8,0.92)',backdropFilter:'blur(10px)',WebkitBackdropFilter:'blur(10px)'}}>
