      ...
      <div style={{display:'flex', flexDirection:'column', gap:'0.55rem'}}>
        ...
        <div>
          ...
          <svg viewBox="0 0 600 60" preserveAspectRatio="none"
            ...
            {(() => {
              const branches = [
                // ── MAIN TRUNK — heavy left, sweeping up-right, tapering ──
                { d: "M 2 38 Q 25 36, 50 32 Q 75 28, 105 26 Q 145 24, 185 22", w: 3.5 },
                { d: "M 185 22 Q 230 21, 280 20 Q 330 19, 380 19 Q 430 19, 480 18", w: 1.8 },
                { d: "M 480 18 Q 510 17, 540 16 Q 565 15, 588 14", w: 1.0 },

                // ── LEFT CLUMP — 3 long graceful forks (was 5 short ones) ──
                { d: "M 12 38 Q 22 22, 38 6",         w: 2.0 },
                { d: "M 38 33 Q 56 18, 78 4",         w: 1.6 },
                { d: "M 70 30 Q 88 18, 108 8",        w: 1.3 },

                // Couple of down branches off the anchor
                { d: "M 18 38 Q 14 50, 8 60",         w: 1.2 },
                { d: "M 50 35 Q 54 48, 60 60",        w: 1.0 },

                // ── MID-LEFT FORK CLUSTER — 2 long curving up-forks ──
                { d: "M 140 25 Q 158 14, 178 4",      w: 1.4 },
                { d: "M 180 23 Q 200 13, 224 4",      w: 1.2 },

                // ── Sub-branches off the LEFT clump (subtle, off the main forks) ──
                { d: "M 28 22 Q 36 16, 46 16",        w: 0.7 },
                { d: "M 50 12 Q 58 8, 68 8",          w: 0.6 },
                { d: "M 76 14 Q 84 10, 94 12",        w: 0.6 },
                { d: "M 90 6  Q 96 3, 104 4",         w: 0.5 },

                // ── Mid-fork sub-twigs ──
                { d: "M 168 12 Q 176 8, 184 10",      w: 0.6 },
                { d: "M 198 10 Q 206 6, 214 8",       w: 0.5 },

                // ── MIDDLE section — 3 graceful forks ──
                { d: "M 250 20 Q 275 12, 300 6",      w: 1.0 },
                { d: "M 320 20 Q 345 12, 372 6",      w: 0.9 },
                { d: "M 295 20 Q 312 28, 326 38",     w: 0.9 },  // down

                // ── RIGHT section — 2 graceful forks, 1 down ──
                { d: "M 410 19 Q 435 12, 462 6",      w: 0.8 },
                { d: "M 460 18 Q 480 12, 502 7",      w: 0.7 },
                { d: "M 430 19 Q 448 28, 462 38",     w: 0.7 },  // down

                // ── FAR-RIGHT tail (very fine, sparse) ──
                { d: "M 520 17 Q 540 12, 558 8",      w: 0.6 },
                { d: "M 560 16 Q 575 12, 588 8",      w: 0.5 },
                { d: "M 545 17 L 555 22",             w: 0.4 },

                // ── A few sparse capillaries (was many — now just a handful) ──
                { d: "M 110 22 L 120 16",             w: 0.5 },
                { d: "M 230 19 L 240 13",             w: 0.5 },
                { d: "M 360 18 L 370 12",             w: 0.4 },
                { d: "M 490 17 L 498 12",             w: 0.4 },
              ];
              return (
                <>
        ...
        <div style={{display:'grid', gridTemplateColumns:'1fr 1fr', gap:6}}>
          <div style={{background:'var(--bg-raised)', border:'1px solid var(--border)', padding:'0.4rem 0.55rem'}}>
