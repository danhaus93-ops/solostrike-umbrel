          ...
          <svg viewBox="0 0 600 60" preserveAspectRatio="none"
            ...
            {(() => {
              const branches = [
                ...
                // ── LEFT CLUMP — 2 graceful upward forks (was 3, simpler) ──
                { d: "M 12 38 Q 22 22, 38 6",         w: 2.0 },
                { d: "M 50 32 Q 65 18, 82 4",         w: 1.5 },

                // ── LEFT down branches (more weight on bottom now) ──
                { d: "M 18 38 Q 14 50, 8 60",         w: 1.2 },
                { d: "M 36 36 Q 38 50, 44 60",        w: 1.1 },
                { d: "M 60 33 Q 62 46, 66 58",        w: 0.9 },

                // ── MID-LEFT — single graceful up-fork (was 2) ──
                { d: "M 160 25 Q 180 14, 200 4",      w: 1.3 },

                // ── MID-LEFT down-branches (NEW — bottom weight) ──
                { d: "M 130 24 Q 138 38, 148 52",     w: 1.0 },
                { d: "M 175 23 Q 184 36, 196 50",     w: 0.9 },
                { d: "M 215 22 Q 222 34, 232 48",     w: 0.8 },

                // ── MIDDLE up-forks (sparse) ──
                { d: "M 270 20 Q 295 12, 322 6",      w: 0.9 },
                { d: "M 345 19 Q 365 12, 388 6",      w: 0.8 },

                // ── MIDDLE down-forks (NEW) ──
                { d: "M 280 21 Q 295 36, 308 50",     w: 0.9 },
                { d: "M 330 20 Q 345 32, 358 46",     w: 0.8 },
                { d: "M 395 19 Q 408 30, 420 42",     w: 0.7 },

                // ── RIGHT — graceful curves ──
                { d: "M 430 19 Q 455 12, 480 6",      w: 0.7 },
                { d: "M 460 18 Q 478 28, 494 40",     w: 0.6 },  // down

                // ── FAR-RIGHT tail ──
                { d: "M 520 17 Q 540 12, 558 8",      w: 0.6 },
                { d: "M 545 17 Q 558 26, 568 36",     w: 0.5 },  // down
                { d: "M 565 16 L 580 9",              w: 0.4 },

                // ── A few sparse capillaries ──
                { d: "M 95 28 L 102 22",              w: 0.5 },
                { d: "M 250 19 L 258 14",             w: 0.4 },
                { d: "M 408 18 L 416 13",             w: 0.4 },
              ];
              return (
                <>
